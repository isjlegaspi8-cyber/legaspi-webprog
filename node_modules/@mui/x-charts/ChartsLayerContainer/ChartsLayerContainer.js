...
var _ChartsAccessibilityProxy = require("../internals/components/ChartsAccessibilityProxy");
...
const ChartsLayerContainer = exports.ChartsLayerContainer = /*#__PURE__*/React.forwardRef(function ChartsLayerContainer(inProps, ref) {
  ...
  (0, _useRegisterPointerInteractions.useRegisterPointerInteractions)();
  ...
  if (process.env.NODE_ENV !== 'production') {
    React.Children.forEach(children, child => {
      if (typeof child === 'object' && child != null && 'type' in child && child.type === _ChartsSurface.ChartsSurface) {
        (0, _warning.warnOnce)('MUI X Charts: ChartsSurface should not be used inside ChartsLayerContainer. Render a ChartsSvgLayer instead.', 'error');
      }
    });
  }
  return (
